...
const (
	SearchService_Search_FullMethodName    = "/home.SearchService/Search"
	SearchService_SearchIn_FullMethodName  = "/home.SearchService/SearchIn"
	SearchService_SearchOut_FullMethodName = "/home.SearchService/SearchOut"
	SearchService_SearchIO_FullMethodName  = "/home.SearchService/SearchIO"
)
...
type SearchServiceClient interface {
	Search(ctx context.Context, in *Home, opts ...grpc.CallOption) (*Home, error)
	SearchIn(ctx context.Context, opts ...grpc.CallOption) (SearchService_SearchInClient, error)
	SearchOut(ctx context.Context, in *Home, opts ...grpc.CallOption) (SearchService_SearchOutClient, error)
...
func (c *searchServiceClient) Search(ctx context.Context, in *Home, opts ...grpc.CallOption) (*Home, error) {
	out := new(Home)
...
func (c *searchServiceClient) SearchIn(ctx context.Context, opts ...grpc.CallOption) (SearchService_SearchInClient, error) {
	stream, err := c.cc.NewStream(ctx, &SearchService_ServiceDesc.Streams[0], SearchService_SearchIn_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (x *searchServiceSearchInClient) Send(m *Home) error {
	return x.ClientStream.SendMsg(m)
}

func (x *searchServiceSearchInClient) CloseAndRecv() (*Home, error) {
...
func (c *searchServiceClient) SearchOut(ctx context.Context, in *Home, opts ...grpc.CallOption) (SearchService_SearchOutClient, error) {
	stream, err := c.cc.NewStream(ctx, &SearchService_ServiceDesc.Streams[1], SearchService_SearchOut_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (x *searchServiceSearchOutClient) Recv() (*Home, error) {
	m := new(Home)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (c *searchServiceClient) SearchIO(ctx context.Context, opts ...grpc.CallOption) (SearchService_SearchIOClient, error) {
	stream, err := c.cc.NewStream(ctx, &SearchService_ServiceDesc.Streams[2], SearchService_SearchIO_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (x *searchServiceSearchIOClient) Send(m *Home) error {
	return x.ClientStream.SendMsg(m)
}

func (x *searchServiceSearchIOClient) Recv() (*Home, error) {
	m := new(Home)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
type SearchServiceServer interface {
	Search(context.Context, *Home) (*Home, error)
	SearchIn(SearchService_SearchInServer) error
	SearchOut(*Home, SearchService_SearchOutServer) error
...
func (UnimplementedSearchServiceServer) Search(context.Context, *Home) (*Home, error) {
...
func (UnimplementedSearchServiceServer) SearchOut(*Home, SearchService_SearchOutServer) error {
...
func _SearchService_Search_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SearchServiceServer).Search(ctx, req.(*Home))
	}
...
func (x *searchServiceSearchInServer) SendAndClose(m *Home) error {
	return x.ServerStream.SendMsg(m)
}

func (x *searchServiceSearchInServer) Recv() (*Home, error) {
	m := new(Home)
...
func (x *searchServiceSearchOutServer) Send(m *Home) error {
	return x.ServerStream.SendMsg(m)
}
...
func (x *searchServiceSearchIOServer) Send(m *Home) error {
	return x.ServerStream.SendMsg(m)
}

func (x *searchServiceSearchIOServer) Recv() (*Home, error) {
	m := new(Home)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
var SearchService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "home.SearchService",
